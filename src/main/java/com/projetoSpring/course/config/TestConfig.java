...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"),OrderStatus.PAID, u1); // Z indica que o horário esta no formato UTC 
		...
		o1.setPayment(pay1); // para salvar um objeto dependente na relação 1:1 não chama o repository do próprio objeto
